...
## 介绍
🚀 qb 是一款简洁快速的终端插件, 🌕 他可以让你在终端中查看币安生态链上的币价，也可以帮助你管理你的币安生态链，并且国内可以方便管理和开启终端代理.
...
同时我也是一个币安链的持有人。当我写代码的时候，我想要去看看我的币价格时，我需要打开手机的App或者去网页，这让我感觉非常麻烦，我仅仅只是想简单方便地看一下当前价而已。
<br>
所以我开发了qb插件，他让我可以简单，快速去查看币安链上币的USDT的价格，然后再继续coding。

- [cointop](https://github.com/cointop-sh/cointop): 一款shell的加密货币查看工具。我在早期的时候有使用过...我感觉太复杂并且太多信息了，拜托如果我要这么多信息我应该打开的是手机的app或者网页了，而且很难操作。并且他追踪不了币安生态链的币。
